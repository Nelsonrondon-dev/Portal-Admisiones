...
@section('content')
    ...
    <div class="row justify-content-md-center pb-5">
        ...
        <div class="row" style="background-image: url({{ asset('img/fondo-master.png') }});  background-position: center;background-repeat: no-repeat; background-size: cover; height: 45vh;">
            ...
            <div class="col-md-4 col-12" >
                ...
                <div class="card p-4" style="box-shadow: 5px 5px 10px rgba(0, 0, 0, 0.25); border-radius: 15px;">
                    ...
                    <div class="card-body text-center" style="color: black">
                        ...
                        <p>
                            Complementa tus conocimientos teóricos con <b>casos 100% prácticos,</b>  totalmente aplicables en campo desde el primer momento.
                        </p><br><br>
            ...
            <div class="col-md-4 col-12">
                <div class="card p-4" style="box-shadow: 5px 5px 10px rgba(0, 0, 0, 0.25); border-radius: 15px;">
                    ...
                    <div class="card-body text-center" style="color: black">
                        ...
                        <p>
                            Tus aptitudes técnicas no serán suficiente sino desarrollas capacidades y aplicas <b>nuevas herramientas </b> de auto-conocimiento personal y dirección de equipos.
                        </p><br>
            ...
            <div class="col-md-4 col-12">
                ...
                <div class="card p-4" style="box-shadow: 5px 5px 10px rgba(0, 0, 0, 0.25); border-radius: 15px;">
                    ...
                    <div class="card-body text-center" style="color: black">
                        ...
                        <p>
                            Durante los últimos años, <b>la competencia entre profesionales se ha globalizado aún más.</b>   El auge del teletrabajo y otros instrumentos colaborativos como la Metodología BIM condicionan un mercado sin fronteras.  
                        </p>
        ...
        <div class="row" style="background-image: url({{ asset('img/fondo-master-2.webp') }});  background-position: center;background-repeat: no-repeat; background-size: cover;">
            ...
            <div class="container mt-2">
                ...
                <div class="row mt-5 pl-5 pr-5 pt-5 pb-0">
                    <div class="col-md-6 col-12" >
                        ...
                        <img class="testimonio_img"  src="{{ asset('img/testimonio.webp') }}" alt="Testimoneo Paola Ortiz"  height="100%">
                    </div>
    
    
                    <div class="col-md-6 col-12">
    
                        <img class="testimonio_tex" src="{{ asset('img/testimoneo2.webp') }}" alt="Testimoneo Paola Ortiz"  height="100%">
                    </div>
    
                </div>


                <div class="row ml-5 mr-5 mt-0 p-5 mb-5" style="background: linear-gradient(180deg, #FFFFFF 0%, #EAFAFF 100%);border-radius: 15px;">
                    ...
                    <div class="col-md-5 col-12" >
                        ...
                        <p>El alumno podrá solicitar la Apostilla de La Haya, que es una certificación que avala la autenticidad del documento, en este caso del título, y permitir su uso y validez en el extranjero.</p>
                    </div>

                    <div class="col-md-1 col-12">
                        <img src="{{ asset('img/apostilla-haya-1.webp') }}" alt="" style="width: 10vh;margin-top: 2em;">
                    </div>
                </div>
                ...
                <div class="row mt-5 mb-5">
                    ...
                    <object  data="{{ $Master->folleto . "#page=3&zoom=60" }}" type="application/pdf" style="height: 80vh;width: 100%;">
                ...
                {{-- <div class="row mt-5 mb-5">
                    <iframe src="{{ $Master->folleto . "#page=3&zoom=60" }}" frameborder="0"></iframe>
